...
![Код SettingsActivity](media/3.png)

**Рисунок 3** — Логика сохранения выбора
...
![Разметка AboutActivity](media/4.png)

**Рисунок 4** — Интерфейс AboutActivity

![Код AboutActivity](media/5.png)

**Рисунок 5** — Логика закрытия Activity
...
![Обработчики в MainActivity](media/6.png)

**Рисунок 6** — Код MainActivity (часть)

![Результат выбора цвета](media/7.png)

**Рисунок 7** — Главный экран после выбора красного цвета

---

## Задания для самостоятельного выполнения

Выбран **вариант 1: изменение цвета фона на главной странице**. Пользователь может выбрать один из трёх цветов (красный, зелёный, синий) в экране настроек. После нажатия «Сохранить» фон MainActivity меняется соответственно, а в TextView выводится сообщение о выбранном цвете.

![Выбор цвета в настройках](media/8.png)

**Рисунок 8** — Выбор зелёного цвета

![Результат применения](media/9.png)

**Рисунок 9** — Главный экран с зелёным фоном
